...
setInterval(() => { // CODE BY KAHRBAA كههربا
  http.get(`http://iquranii.glitch.me/`);
}, 280000);
...
const prefix = "*"; // البرافيكس
   const GUILDID = '748207784708931676'; // اي دي السيرفر  
   const CHANNELID = '754924908898943086'; // اي دي الروم
//======================================[Client]======================================
// CODE BY KAHRBAA كههربا

client.on('ready', () => {
  console.log(`Logged in as ${client.user.tag}!`);
   client.user.setActivity("القرآن حياة",{type: 'WATCHING'})
});
// CODE BY KAHRBAA كههربا
const { Client } = require('discord.js');
const ytdl  = require('ytdl-core');// CODE BY KAHRBAA كههربا
const url = 'https://www.youtube.com/watch?v=Jcl7MIRzvK0'; // هنا فديو الخاص ب القرأن الكريم كامل // CODE BY KAHRBAA كههربا
